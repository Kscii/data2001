...
def build_top_bottom_table(scores_df: pd.DataFrame, *, n: int) -> pd.DataFrame:
    ...
    return pd.concat([top, bottom], ignore_index=True)[["rank_group", *columns]]
