...
from data2001_assignment.task3_score.correlation import compute_income_correlation
from data2001_assignment.common.types import StepSummary
from data2001_assignment.config import Settings
from data2001_assignment.db.repositories.read import select_score_input
from data2001_assignment.db.repositories.write import upsert_scores
from data2001_assignment.task2_import.boundaries.areas import selected_sa4_names
from data2001_assignment.task3_score.records import (
    Sa2ScoreRecord,
    ScoreInputRecord,
    score_records_to_db_rows,
)
from data2001_assignment.task3_score.scoring import compute_scores
