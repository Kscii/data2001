...
def fetch_sa2_income(client: ArcGISClient, settings: Settings) -> list[dict[str, Any]]:
...
def normalise_income_feature(feature: dict[str, Any], settings: IncomeSettings) -> dict[str, Any]:
